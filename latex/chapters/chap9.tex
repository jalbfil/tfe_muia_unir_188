...
(protocolo pendiente de evidencia individual)
\end{tabular}
}
...
\begin{description}
    ...
    árboles poco profundos con una capa logística dispersa. Exporta 30 reglas activas y
    ...
    se emplea un esquema one-vs-rest P1--P4. Su papel es diagnóstico: comprobar si una implementación externa aporta ventaja frente al núcleo reproducible elegido.
\end{description}
...
motivo de divergencia, revisor, marca temporal y huella de entrada. Las divergencias de dos o más niveles se marcan como casos de auditoría especial.

La muestra preparada incluye todos los falsos negativos P1 de la
...
\section{Protocolo de evaluación exploratoria con participantes}

Como complemento de la evaluación técnica, se ha preparado un protocolo breve para
estudiar usabilidad, confianza y utilidad percibida del prototipo. El diseño contempla
un acceso controlado mediante Google Colab, casos representativos y un cuestionario
con escala Likert de 1 a 5 sobre razonabilidad de la prioridad, claridad de la
explicación, confianza aportada por las señales y visibilidad de la decisión humana.

La muestra prevista comprende nueve perfiles anonimizados distribuidos entre
profesionales vinculados a puestos de mando, comunicaciones críticas y emergencias;
usuarios técnicos familiarizados con IA; y usuarios no especializados en IA. En el
momento de cierre solo se conservan resultados agregados, sin las respuestas
individuales anonimizadas necesarias para reconstruir los cálculos. Por rigor
metodológico, esas medias no se incorporan como evidencia empírica y el estudio se
documenta como protocolo preparado. Su ejecución reproducible y el análisis de
resultados quedan condicionados a conservar las respuestas individuales y el
...
\begin{enumerate}
    ...
    \item La ejecución de la alternativa RuleFit externa se ha realizado de forma diagnóstica reducida
