...
OE8 & Logrado & Se evalúa con una partición estratificada y otra temporal, control de fugas, errores P1 (59 falsos negativos), análisis por subgrupos y fidelidad de explicaciones. & Cap.~\ref{cap:9}, Anexo~\ref{cap:anexod} \\ \hline
\end{tabular}
...
\begin{enumerate}
    ...
    heurístico en macro-F1, mantiene la sensibilidad P1 por encima del criterio fijado y
    ...
    \item \textbf{Trazabilidad, preparación de la revisión interna y fidelidad explicativa.} Se
...
los 119 casos de la muestra preparada, el juez determinista sin conexión obtiene una tasa de cumplimiento
...
índice de métricas, evidencias, muestra preparada para revisión interna, fidelidad
...
\begin{enumerate}
    ...
    negativos P1, pero sus campos de decisión humana permanecen pendientes de completar.
\end{enumerate}
...
\begin{enumerate}
    ...
    \item \textbf{Revisión interna.} Completar la revisión de los 119
...
de estabilidad; y la muestra preparada para revisión abre el camino para contrastar el sistema con
criterio humano.
