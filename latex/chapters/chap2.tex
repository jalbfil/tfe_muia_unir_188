...
Para ello, la Capa 3 utiliza un LLM local cuantizado (Grattafiori et al., \citeyearNP{Llama3_2024}; Qwen Team, \citeyearNP{Qwen25_2024}), recuperación aumentada sobre un corpus normativo de Castilla y León y herramientas MCP.
