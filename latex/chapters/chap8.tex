...
Para realizar una evaluación exploratoria con participantes, el equipo habilitó
y utilizó un acceso de prueba mediante un cuaderno en Google Colab. Este acceso no se
