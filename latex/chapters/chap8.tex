...
backend en vivo. Los resultados se conservan en los reportes reproducibles de validación
...
reproducible Capa 1--Capa 2--Capa 3. Estos informes se conservan como artefactos de
validación en el repositorio. Su finalidad es comprobar que la salida real de Capa 1
...
Un índice maestro estructurado actúa como registro de trazabilidad de esta relación entre prototipo, resultados y documentación. En este archivo de control se indexan los hashes de los conjuntos de datos de prueba, los pesos del modelo y las métricas calculadas. Esta estructura facilita una validación externa rápida y automatizada de los resultados declarados en la memoria.
