...
\texttt{Priority Recommendation} & Salida de la Capa 2: prioridad recomendada, probabilidades, reglas activadas y versión del modelo. & \texttt{PriorityRecommendat ion.schema.json} \\ \hline
\texttt{Operator Recommendation} & Explicación entregada al operador, citas legales, advertencias y modo degradado si aplica. & \texttt{OperatorRecommendat ion.schema.json} \\ \hline
