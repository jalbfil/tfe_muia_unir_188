...
Cuatro fuentes débiles y deterministas forman la etiqueta final. La primera aplica
reglas heurísticas y la segunda combina señales con intensificadores. Las dos restantes
se denominan proxy de agrupación y proxy de anotador LLM por compatibilidad con el
diseño experimental. En la ejecución evaluada no realizan agrupamiento vectorial ni
invocan un modelo generativo. Se trata, por tanto, de votos programáticos
