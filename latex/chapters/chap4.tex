...
\begin{enumerate}
    ...
    \item[OE8.] Evaluar el prototipo con una partición estratificada y otra temporal, control de fugas de información, estudio de errores P1, análisis por subgrupos, preparación de una muestra de revisión interna y evaluación automatizada de fidelidad explicativa.
\end{enumerate}
