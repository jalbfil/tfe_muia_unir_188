...
\begin{enumerate}
    ...
    \item[OE5.] Diseñar e implementar una Capa 2 interpretable, comparar una l\'inea base heur\'istica con RuleFit-lite y una ejecuci\'on diagn\'ostica de \texttt{imodels}, selecciónar el modelo mediante la partici\'on de validaci\'on y reservar la partici\'on de prueba para la estimaci\'on final.
...
\begin{enumerate}
    ...
    \item[PI2.] ¿Qu\'e aporta un modelo interpretable como RuleFit-lite frente a una l\'inea base heur\'istica basada en señales textuales y reglas operativas?
